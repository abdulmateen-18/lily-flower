...
let parallaxActive: boolean = false;
let bloomTimeouts: ReturnType<typeof setTimeout>[] = [];

// ── DOM refs ───────────────────────────────────────────────

const canvas      = document.getElementById('particles')    as HTMLCanvasElement;
const ctx         = canvas.getContext('2d')!;
const flowerWrap  = document.getElementById('flowerWrap')   as HTMLElement;
const heading     = document.getElementById('heading')      as HTMLElement;
const messageWrap = document.getElementById('messageWrap')  as HTMLElement;
const centerGlow  = document.getElementById('centerGlow')   as unknown as SVGCircleElement;
const stamens     = document.getElementById('stamens')      as unknown as SVGGElement;
const lily        = document.getElementById('lily')         as unknown as SVGSVGElement;
const petalGroups = document.querySelectorAll<SVGGElement>('.petal-group');
